...
% \usepackage{sectsty}
\usepackage{amsmath,amssymb,latexsym,cancel,amsthm,mathtools}
...
\definecolor{gris fondo}{RGB}{249, 249, 249}
...
\NewDocumentCommand\caixa{m O{\Large #1} O{gris fondo} O{primary} O{number within=chapter}}
{
...
% \caixa{Corolari}[Corol·lari][myp!10][myp!85!black]
% \caixa{Lema}[Lema][mylenmabg][mylenmafr]
% \caixa{Propo}[Proposició][mypropbg][mypropfr]
% \caixa{defi}[Definició][primary!12][primary]
% \caixa{Teorema}[Teorema][primary!12][primary]

% 1. Definim "Teorema" primer. Li passem un 5è paràmetre buit "[]" 
% per sobreescriure el "number within=chapter" i fer que el comptador sigui global.
\caixa{Teorema}[Teorema][primary!12][primary]%[]

% 2. Definim la resta d'entorns indicant que facin servir el comptador de "Teorema".
\caixa{Corolari}[Corol·lari][myp!10][myp!85!black][use counter from=Teorema]
\caixa{Lema}[Lema][mylenmabg][mylenmafr][use counter from=Teorema]
\caixa{Propo}[Proposició][mypropbg][mypropfr][use counter from=Teorema]
\caixa{defi}[Definició][primary!12][primary]%[use counter from=Teorema]

\caixa{Nota}[Nota][white][migris][no counter]
\caixa{Propietats}[Propietats][white][migris][no counter]
\caixa{preg}[Pregunta][white][migris][no counter]
\caixa{Claim}[Claim:][white][migris][no counter]

%---------------
%   Comandos
%---------------
\newcommand{\teorema}[3]{\begin{Teorema}{#1}{#2}#3\end{Teorema}}
\newcommand{\coro}[3]{\begin{Corolari}{#1}{#2}#3\end{Corolari}}
\newcommand{\lema}[3]{\begin{Lema}{#1}{#2}#3\end{Lema}}
\newcommand{\Prop}[3]{\begin{Propo}{#1}{#2}#3\end{Propo}}
\newcommand{\propietats}[3]{\begin{Propietats}{#1}{#2}#3\end{Propietats}}
...
\titleformat{\subsection}{\Large\color{primary}\bfseries}{\thesubsection}{1em}{#1}
%---------------------
% Portada
%---------------------
