...
\caja{Corolari}[Corol·lari][myp!10][myp!85!black][use counter from=Teorema]
\caja{Lema}[Lema][mylenmabg][mylenmafr][use counter from=Teorema]
\caja{Propo}[Proposició][mypropbg][mypropfr][use counter from=Teorema]
\caja{defi}[Definició][primary!12][primary][use counter from=Teorema]
