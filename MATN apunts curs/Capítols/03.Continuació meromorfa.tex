...
\teorema{Expansió de Fourier.}{\label{4.13_teorema resultat d'anmat}Sigui $f\colon \RR\to \RR$ una funció contínua i monòtona a trossos. Descrivim
\[
...
\teorema{Fórmula de Poisson summation.}{\label{4.14_teorema Poisson summation} Sigui $f$ una funció }
