...
Ara, per a valors generals de $A$ i $B$, només cal notar que sempre estem prenent $A$ i $B$ enters, i per tant, podem escriure
\[
...
\]
Com que la funcó és contínua i monòtona a trossos (en el fons és una Gaussiana), podem aplicar la fórmula de Poisson:
\[
\sideset{}{'}\sum_{-N\leq n\leq N}e^{-\frac{(n+\alpha)^2}{x}\pi}=
